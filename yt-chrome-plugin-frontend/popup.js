...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const API_KEY = 'AIzaSyDTQpdrTTZsDoO8HjrmCVujXTqncZDps3A';
  ...
  chrome.tabs.query({ active: true, currentWindow: true }, async (tabs) => {
    ...
    if (match && match[1]) {
      ...
      outputDiv.innerHTML += `<p class="status-msg">Fetched ${comments.length} comments. Performing sentiment analysis...</p>`;
