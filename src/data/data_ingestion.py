...
def main():
    try:
        ...
        df = load_data(
            data_url="https://raw.githubusercontent.com/tinyu1295/SMA-Sentiment-Intelligence-Plugin/refs/heads/main/reddit.csv")
        ...
        save_data(train_data, test_data, data_path=os.path.join(
