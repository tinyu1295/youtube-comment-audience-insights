...
def save_data(train_data: pd.DataFrame, test_data: pd.DataFrame, data_path: str) -> None:
    ...
    try:
        ...
        train_data.to_csv(os.path.join(interim_data_path,
                          "train_processed.csv"), index=False)
        test_data.to_csv(os.path.join(interim_data_path,
...
def main():
    try:
        ...
        save_data(train_processed_data,
                  test_processed_data, data_path='./data')
    except Exception as e:
        logger.error(
